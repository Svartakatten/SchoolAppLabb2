...
namespace SchoolAppLabb2.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public CoursesController(SchoolAppLabb2DbContext context)
        {
            _context = context;
        }
        ...
        {
            var schoolAppLabb2DbContext = _context.Courses.Include(c => c.Teacher);
            return View(await schoolAppLabb2DbContext.ToListAsync());
        }
